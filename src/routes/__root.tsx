  ...
  return (
    ...
    >
      ...
      <Layout>
        <Layout.Sidebar>
          ...
          <Layout.Sidebar.Body>
            <Layout.Sidebar.Section>
              <Layout.Sidebar.Button icon={<SearchIcon />}>
                Search
            ...
            <Layout.Sidebar.Section>
              <Layout.Sidebar.Item to="/" icon={<HomeIcon />} active>
                Home
              </Layout.Sidebar.Item>
              <Layout.Sidebar.Item to="/timers" icon={<ClockIcon />}>
                Timers
              </Layout.Sidebar.Item>
              <Layout.Sidebar.Button icon={<ChartIcon />}>
                Reports
              </Layout.Sidebar.Button>
              <Layout.Sidebar.Button icon={<TagIcon />}>
                Categories
              </Layout.Sidebar.Button>
              <Layout.Sidebar.Button icon={<CogIcon />}>
                Settings
              </Layout.Sidebar.Button>
            </Layout.Sidebar.Section>
          ...
          <Layout.Sidebar.Footer>
            <Layout.Sidebar.Section>
              <Layout.Sidebar.Button icon={<QuestionIcon />}>
                Support
              </Layout.Sidebar.Button>
              <Layout.Sidebar.Button icon={<SparklesIcon />}>
                Changelog
              </Layout.Sidebar.Button>
            </Layout.Sidebar.Section>
            <div className="mt-4">
        ...
        <Layout.Main>
          <Layout.Main.Header>
            <Layout.Main.Title>Time Tracker</Layout.Main.Title>
          </Layout.Main.Header>
          <Layout.Main.Body>
            <Outlet />
          </Layout.Main.Body>
